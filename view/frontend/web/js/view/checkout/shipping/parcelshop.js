            ...
            this.selectedMethod = ko.computed(function () {
                ...
                if (selectedMethod === 'dpdpickup_dpdpickup') {
                    if ($('#dpd_parcelshop_container').length === 0) {
                        ...
                        $('#dpd_parcelshop_container').html('<div id="parcelshop" class="parcelshopwrapper"><a href="#" id="get_parcels_link" >' + $.mage.__('Click here to select your Parcelshop') + '</a><div id="map_container"><div id="map_canvas" class="gmaps"></div></div></div>');
                    }
                } else {
