...
class DpdExpress12 extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'dpdexpress12';
    ...
    {
        return ['dpdexpress12' => $this->getConfigData('name')];
    }
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $method->setCarrier('dpdexpress12');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('dpdexpress12');
        ...
        if ($this->getConfigData('rate_type') == 'table') {
            ...
            $request->setShippingMethod('dpdexpress12');
