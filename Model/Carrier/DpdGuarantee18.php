...
class DpdGuarantee18 extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'dpdguarantee18';
    ...
    {
        return ['dpdguarantee18' => $this->getConfigData('name')];
    }
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $method->setCarrier('dpdguarantee18');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('dpdguarantee18');
        ...
        if ($this->getConfigData('rate_type') == 'table') {
            ...
            $request->setShippingMethod('dpdguarantee18');
